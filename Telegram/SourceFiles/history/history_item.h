...
public:
	...
	void destroy();
	[[nodiscard]] bool isDeletedPreserved() const {
		return _isDeletedPreserved;
	}
	void setDeletedPreserved(bool deleted = true) {
		_isDeletedPreserved = deleted;
	}
...
private:
	...
	bool _isDeletedPreserved = false;
